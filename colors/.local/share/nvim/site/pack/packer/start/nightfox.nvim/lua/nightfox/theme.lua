...
function M.apply(colors, config)
  ...
  -- Background color == termimal bg color
  c.bg = none
  ...
  theme.groups = {
    ...
    ColorColumn = {bg = util.darken(c.bg_visual, 0.3)}, -- used for the columns set with 'colorcolumn'
    ...
    MatchParen = {fg = c.orange_br, style = config.inverse.match_paren and "inverse,bold" or "bold"}, -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
    ...
    Normal = {fg = config.transparent, bg = config.transparent and c.none or c.bg}, -- normal text
    NormalNC = {fg = config.transparent, bg = config.transparent and c.none or config.alt_nc and c.bg_alt or c.bg}, -- normal text in non-current windows
    ...
    Constant = {fg = c.orange_br}, -- (preferred) any constant
    ...
    Function = {fg = c.yellow_br, style = config.styles.functions}, -- function name (also: methods for classes)
    ...
    Keyword = {fg = c.orange, style = config.styles.keywords}, --  any other keyword
    -- Exception     = { }, --  try, catch, throw

    PreProc = {fg = c.white_br}, -- (preferred) generic Preprocessor
    Include = {fg = c.magenta_br}, --  preprocessor #include
    -- Define        = { }, --   preprocessor #define
    -- Macro         = { }, --    same as Define
    -- PreCondit     = { }, --  preprocessor #if, #else, #endif, etc.

    Type = {fg = c.blue_br}, -- (preferred) int, long, char, etc.
    StorageClass = {fg = c.blue_br}, -- static, register, volatile, etc.
    Structure = {fg = c.blue_br}, --  struct, union, enum, etc.
    Typedef = {fg = c.blue_br}, --  A typedef
    ...
    Todo = {bg = c.yellow_br, fg = c.bg}, -- (preferred) anything that needs extra attention; mostly the keywords TODO FIXME and XXX
    qfLineNr = {fg = c.yellow},
    qfFileName = {fg = c.blue},
    htmlH1 = {fg = c.magenta, style = "bold"},
    htmlH2 = {fg = c.blue, style = "bold"},
    -- mkdHeading = { fg = c.orange_br, style = "bold" },
    ...
    markdownHeadingDelimiter = {fg = c.orange_br, style = "bold"},
    ...
    DiagnosticVirtualTextHint = {bg = util.darken(c.green_dm, 0.05), fg = c.green_dm}, -- Used for "Hint" diagnostic virtual text
    ...
    LspSignatureActiveParameter = {fg = c.orange_br},
    ...
    TSConstant = {fg = c.orange_br}, -- For constants
    TSConstBuiltin = {fg = c.magenta_br}, -- For constant that are built in the language: `nil` in Lua.
    -- TSConstMacro        = { };    -- For constants that are defined by macros: `NULL` in C.
    -- TSError             = { };    -- For syntax/parser errors.
    -- TSException         = { };    -- For exception related keywords.
    TSField = {fg = c.cyan_dm}, -- For fields.
    rustTSField = {fg = c.cyan_dm},
    -- TSFloat             = { };    -- For floats.
    -- TSFunction = { fg = c.fg_gutter }, -- For function (calls and definitions).
    TSFuncBuiltin = {fg = c.yellow_br}, -- For builtin functions: `table.insert` in Lua.
    TSFuncMacro = {fg = c.yellow}, -- For macro defined fuctions (calls and definitions): each `macro_rules` in Rust.
    -- TSInclude           = { };    -- For includes: `#include` in C, `use` or `extern crate` in Rust, or `require` in Lua.
    TSKeyword = {fg = c.orange, style = config.styles.keywords}, -- For keywords that don't fall in previous categories.
    TSKeywordFunction = {fg = c.orange, style = config.styles.functions}, -- For keywords used to define a fuction.
    TSLabel = {fg = c.magenta_br}, -- For labels: `label:` in C and `:label:` in Lua.
    ...
    TSProperty = {fg = c.cyan_dm}, -- Same as `TSField`.
    tomlTSProperty = {fg = c.cyan}, -- Differentiates between string and properties
    ...
    -- TSType              = { };    -- For types.
    TSTypeBuiltin = {fg = c.magenta_br}, -- For builtin types.
    ...
    TSURI = {fg = c.orange_br}, -- Any URI like a link or email.
    -- Plugins ------------------------------------------------------------------------------------
    ...
    -- Hop
    HopNextKey = {fg = c.hint, style = "underline"},
    HopNextKey1 = {fg = c.hint, style = "underline"},
    HopNextKey2 = {fg = c.hint, sytle = "underline"},
    HopUnmatched = {fg = c.comment},
    -- Clever-f
    CleverFDefaultLabel = {fg = c.hint, style = "underline"},
    -- Symbol outline
    ...
    StartifyPath = {fg = c.blue_br},
    StartifyFile = {fg = c.green_br},
    StartifySlash = {fg = c.blue_br},
    StartifyHeader = {fg = c.blue_br},
    StartifySection = {fg = c.purple},
    StartifyFooter = {fg = c.green},
    -- Vimwiki
    VimwikiHeader1 = {fg = c.yellow_br, style = "bold"},
    VimwikiHeader2 = {fg = c.blue_br, style = "bold"},
    VimwikiHeader4 = {fg = c.cyan, style = "bold"},
    VimwikiHeader3 = {fg = c.blue, style = "bold"},
    VimwikiHeader5 = {fg = c.yellow, style = "bold"},
    VimwikiHeader6 = {fg = c.white, style = "bold"},
    VimwikiLink = {fg = c.green_br, style = "underline"},
    VimwikiHeaderChar = {fg = c.cyan},
    VimwikiHR = {fg = c.cyan_br},
    VimwikiList = {fg = c.green},
    VimwikiTag = {fg = c.magenta_br},
    VimwikiMarkers = {fg = c.orange_br},
    -- ChangesPlugin
    ChangesSignTextAdd = {fg = c.blue},
    ChangesSignTextDel = {fg = c.red},
    ChangesSignTextCh = {fg = c.yellow},
    ChangesSignTextDummyAdd = {fg = c.blue_dm},
    ChangesSignTextDummyCh = {fg = c.yellow_dm},
    -- Indent-Blankline
    IndentBlanklineIndent1 = {bg = "#231515"},
    IndentBlanklineIndent2 = {bg = "#141924"}
  }
